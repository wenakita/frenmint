const WrappedPoolsStakerABI = [
  ...
  },
  {
    ...
    outputs: [
      { internalType: "uint256", name: "_rewardsPerUnitTime", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "uint256", name: "_timeUnit", type: "uint256" }],
    name: "setTimeUnit",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    ...
    name: "stakers",
    outputs: [
      { internalType: "uint64", name: "amountStaked", type: "uint64" },
      {
        internalType: "uint64",
...
export default WrappedPoolsStakerABI;
